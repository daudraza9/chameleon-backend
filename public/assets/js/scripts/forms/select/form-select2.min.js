!function (e, t, c) {
    ...
    }), c(".select2-placeholder-multiple").select2({placeholder: "Select Roles To Filter Users"}), c(".hide-search").select2({minimumResultsForSearch: 1 / 0}), c(".max-length").select2({
        maximumSelectionLength: 2,
        placeholder: "Select maximum 2 items"
    });
    var s = c(".js-example-events");
    s.select2({placeholder: "DOM Events"}), s.on("select2:open", function (e) {
    ...
    var l = c(".js-example-programmatic").select2(), r = c(".js-example-programmatic-multi").select2();
    r.select2({placeholder: "Programmatic Events"}), c(".js-programmatic-set-val").on("click", function () {
    ...
    c(".select2-data-array").select2({
        data: [{id: 0, text: "Array Element 1"}, {id: 1, text: "Array Element 2"}, {
            id: 2,
            text: "Array Element 3"
        }, {id: 3, text: "Array Element 4"}, {id: 4, text: "Array Element 5"}]
    ...
    }), c(".select2-tags").select2({tags: !0}), c(".select2-tokenizer").select2({
        tags: !0,
        tokenSeparators: [",", " "]
    ...
    }), c(".select2-language").select2({language: "es"}), c(".select2-rtl").select2({
        placeholder: "RTL Select",
        dir: "rtl"
    }), c(".select2-diacritics").select2({placeholder: "Type 'aero'"}), c(".select2-theme").select2({
        placeholder: "Classic Theme",
        theme: "classic"
    }), c(".select2-templating").select2({
        templateResult: o,
        templateSelection: o
    }), c(".select2-size-lg").select2({containerCssClass: "select-lg"}), c(".select2-size-sm").select2({containerCssClass: "select-sm"}), c(".select2-size-xs").select2({containerCssClass: "select-xs"}), c(".select2-bg").each(function (e, t) {
        var a = "", s = "", l = c(this).data("bgcolor");
        ...
        var a = "", s = "", l = c(this).data("border-color");
